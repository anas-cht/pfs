...
if uploaded_pdf and "processed" not in st.session_state:
    saved_path = save_uploaded_file(uploaded_pdf)
    asyncio.run(process_and_index_documents(saved_path))
...
if user_input:
    ...
    with st.spinner("🤖 Thinking... extracting context from your PDF..."):
